...
1. You *add a* =#+SETUPFILE:= *directive* in the preamble of your document (to include
   ...
   ,#+SETUPFILE: https://PierreTechoueyres.github.io/org-html-themes/org/theme-NAME.setup
   #+end_src
...
[[https://github.com/PierreTechoueyres/org-html-themes/issues/new][GitHub issue tracker]].
